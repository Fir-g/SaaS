...
export function AppHeader() {
  ...
  return (
    <header
      className="h-16 border-b bg-card/50 backdrop-blur-sm flex items-center justify-between px-4 md:px-6 fixed top-0 left-0 right-0 z-40"
      style={{ width: '100%' }}
    >
      ...
      <div className="flex items-center lg:gap-3 lg:gap-4 lg:ml-6">
        {/* Large screen logo */}
        <img
          src={import.meta.env.BASE_URL + 'freight-tiger.svg'}
          alt="Freight Tiger"
          className="hidden sm:block h-8 w-auto object-contain"
          onError={(e) => {
            e.currentTarget.onerror = null;
            e.currentTarget.src = import.meta.env.BASE_URL + 'favicon.ico';
          }}
        />
