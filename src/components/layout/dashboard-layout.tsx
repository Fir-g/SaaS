...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <SidebarProvider defaultOpen={true}>
      <div className="min-h-screen min-w-0 flex flex-col bg-background w-full">
        <AppHeader />
        <div className="flex flex-1 overflow-hidden">
          <AppSidebar />
          <main className="flex-1 pl-6 md:pl-8 bg-background min-w-0">
            <div className="w-full lg:max-w-7xl lg:mx-auto px-4 sm:px-6 lg:px-8 h-full pt-16 min-w-0 xl:max-w-none xl:mx-0 xl:px-2 2xl:max-w-none 2xl:px-2">
              {children}
            </div>
          </main>
        </div>
