import { Cloud, Loader as Loader2 } from "lucide-react";
    ...
    <div className="absolute inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-2xl shadow-2xl flex flex-col items-center max-w-sm mx-4">
        <div className="relative mb-4">
          <Cloud className="h-12 w-12 text-brand-primary" />
          <div className="absolute inset-0 flex items-center justify-center">
            <Loader2 className="h-6 w-6 animate-spin text-brand-primary" />
          </div>
        </div>
        <div className="text-brand-primary font-semibold text-lg mb-2">Uploading files...</div>
