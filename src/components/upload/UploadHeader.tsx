...
export const UploadHeader = ({ onClose }: UploadHeaderProps) => {
  return (
    <div className="bg-brand-primary px-4 sm:px-6 lg:px-8 py-4 sm:py-6 text-white relative">
      <button
        onClick={onClose}
      ...
      <div className="flex items-center space-x-3 sm:space-x-4 pr-12">
        <div className="bg-brand-accent/30 p-2 sm:p-3 rounded-xl flex-shrink-0">
